...
export const Card = function ({heading,subheading,buttonText,onClick,updateOnClick, deleteOnClick}){
    return <div className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
        ...
        <SubHeading label={subheading}></SubHeading>
        <div className="flex flex-wrap justify-between items-center gap-4 mt-4">
        <Button onClick={onClick} label={buttonText}></Button>
